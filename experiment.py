...
def run(original_src="./dataset", option=["-S", "S", "-T", "S","-N", 50]):
  ...
  out = {"EQ": ['EQ', 0.583,0.783], "JDT": ['JDT',0.795, 0.767], "LC": ['LC',0.575, 0.655], "ML": ['ML', 0.734,0.692], "PDE": ['PDE',0.684, 0.717],
         ...
         "xerces-1.2": ['xerces-1.2', 0.624,0.489], "JM1":["JM1",0,0],"CM1": ['CM1', 0.653,0.717], "MW1": ['MW1', 0.612,0.727], "PC1": ['PC1', 0.787,0.752],
         "PC2":["PC2",0,0],"PC3": ['PC3', 0.794,0.738], "PC4": ['PC4',0.900, 0.682], "PC5":["PC5",0,0],"KC3":["KC3",0,0],"MC2":["MC2",0,0],
         "ar1": ['ar1', 0.582,0.734], "ar3": ['ar3', 0.574,0.823],
